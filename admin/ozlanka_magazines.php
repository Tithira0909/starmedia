  ...
  <div class="shell">
    <div class="hero-inner">
      ...
      <div class="hero-actions">
        <a class="btn ghost" href="<?= $adminBase ?>/new_ozlanka_magazine.php">+ New</a>
          ...
          <tr>
            ...
            <td data-label="Published" class="no-wrap">
              <?php if ((int)($r['is_published'] ?? 0) === 1): ?>
                ...
                <a class="btn pill ghost" href="<?= $adminBase ?>/toggle_publish_ozlanka_magazine.php?id=<?= (int)$r['id'] ?>&to=0">Unpublish</a>
              <?php else: ?>
                <span class="chip chip-muted">Unpublished</span>
                <a class="btn pill ghost" href="<?= $adminBase ?>/toggle_publish_ozlanka_magazine.php?id=<?= (int)$r['id'] ?>&to=1">Publish</a>
              <?php endif; ?>
            </td>
            ...
            <td class="t-right">
              <form method="post" action="<?= $adminBase ?>/delete_ozlanka_magazine.php"
                    onsubmit="return confirm('Delete this OzLanka magazine?')">
