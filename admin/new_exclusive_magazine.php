...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
  try {
    ...
    $pdo = pdo();
    $sql = "
      INSERT INTO exclusive_magazines
    ...
    header('Location: ' . $adminBase . '/exclusive_magazines.php');
    exit;
  } catch (Throwable $e) {
    $error = $e->getMessage();
  }
...
<section class="shell">
  ...
  <form class="ui-card mag-form" method="post" enctype="multipart/form-data">
    ...
    <div class="form-actions">
      <a class="btn ghost" href="<?= $adminBase ?>/exclusive_magazines.php">← Back</a>
      <button class="btn primary" type="submit">Save exclusive magazine</button>
    </div>
  </form>
</section>
