...
<section class="hero-green">
  <div class="shell">
    <div class="hero-inner">
      <h1 class="hero-title">Lanka Puwath</h1>
      <div class="hero-actions">
        <a class="btn ghost" href="<?= $adminBase ?>/new_exclusive_magazine.php">+ New</a>
  ...
  <div class="ui-card">
    <div class="table-wrap">
      <table class="table-green">
        ...
        <tbody id="sortable-tbody" data-table="exclusive_magazines">
          ...
          <tr data-id="<?= (int)$r['id'] ?>">
            ...
            <td data-label="Published" class="no-wrap">
              <?php if ((int)($r['is_published'] ?? 0) === 1): ?>
                ...
                <a class="btn pill ghost" href="<?= $adminBase ?>/toggle_publish_exclusive_magazine.php?id=<?= (int)$r['id'] ?>&to=0">Unpublish</a>
              <?php else: ?>
                <span class="chip chip-muted">Unpublished</span>
                <a class="btn pill ghost" href="<?= $adminBase ?>/toggle_publish_exclusive_magazine.php?id=<?= (int)$r['id'] ?>&to=1">Publish</a>
              <?php endif; ?>
            </td>
            ...
            <td class="t-right">
              <form method="post" action="<?= $adminBase ?>/delete_exclusive_magazine.php"
                    onsubmit="return confirm('Delete this exclusive magazine?')">
