...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
  try {
    ...
    ";
    // 🔁 If your column is called `published` (NOT `is_published`):
    // change `is_published` above to `published`.
...
<section class="hero-green">
  <div class="shell">
    <div class="hero-inner">
      <div>
        <h1 class="hero-title">Create a New Magazine</h1>
...
<section class="shell">
  ...
  <form class="ui-card mag-form" method="post" enctype="multipart/form-data">
    ...
    <div class="form-actions">
      ...
      <button class="btn primary" type="submit">Save magazine</button>
    </div>
  </form>
</section>
